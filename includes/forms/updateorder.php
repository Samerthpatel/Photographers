...
<head>
    ...
    <title>Picture Perfect Portraits Update Order</title>
...
<body>
    ...
    <br><br>
    <br><br>
    <form id="form" method="POST" action="../php/updateorder1.php">
            <h2>Picture Perfect Portraits Update Order Form</h2>
            <br><br>
            <div>
            ...
            <br><br>
            <div>
                <label for="update"><b>Updated Order:</b></label>
                <input type="text" name="update" id="update" placeholder="updated order" required>
            </div>
            <br><br>
            <br><br>
            <button type="submit" action="../php/updateorder1.php" onclick='return con()'>Submit</button>
    </form>
    <br><br>
    <div id="error"></div>
    <script>
        function con()
        {
            return confirm('You are about to update this order. Are you sure you want to update?');
        }
    </script>
</body>
</html>